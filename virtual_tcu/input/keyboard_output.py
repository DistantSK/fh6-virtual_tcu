...
class KeyboardOutput(OutputInterface):
    ...
    @property
    def use_rev_blip(self) -> bool:
        return bool(self._config.get("feat_rev_blip", False))
    ...
    def shift_to(self, from_gear: int, target_gear: int):
        ...
        elif is_downshift and self.use_rev_blip:
    ...
    def _press_release_with_blip(self, key: str):
        """Downshift rev match without clutch: shift and tap throttle together."""
    ...
    def _press_release_with_clutch(self, key: str):
        ...
        do_blip = is_downshift and self.use_rev_blip
        blip_key = self.blip_key
        blip_s = max(0.02, self.blip_ms / 1000.0)
        pressed_ck = False
        pressed_blip = False
        ...
        try:
            ...
            shift_hold_s = overlap_s
            if do_blip:
                shift_hold_s = max(overlap_s, blip_s)
