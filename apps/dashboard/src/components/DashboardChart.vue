...
<template>
  <div
    class="border-tcu-border bg-tcu-bg-1 flex h-full min-h-0 flex-col overflow-hidden rounded-lg border"
  >
    <div class="border-tcu-border flex shrink-0 items-center justify-between border-b px-3 py-2">
      <span class="text-tcu-txt-dim text-[10px] tracking-widest uppercase">Live Telemetry</span>
